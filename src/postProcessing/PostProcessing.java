...
public class PostProcessing
{
	...
	public static void init(Loader loader)
	{
		...
		hBlur3 = new HorizontalBlur(Display.getWidth() / 2, Display.getHeight() / 2);
		vBlur3 = new VerticalBlur(Display.getWidth() / 2, Display.getHeight() / 2);
	...
	{
		start();
		//brightFilter.render(brightTexture);
		...
		combineFilter.render(colourTexture, vBlur3.getOutputTexture());
		end();
	}
