...
public class MasterRenderer 
{
	...
	public NormalMappingRenderer normalMapRenderer;
	public NormalMappingShader normalMapShader = new NormalMappingShader();
	...
	public void renderAll(List<Entity> entities, List<Entity> normalEntities, List<Terrain> terrains, List<Light> lights, Camera camera, Vector4f clipPlane)
	{
	...
	public void render(List<Light> lights, Camera camera, Vector4f clipPlane)
	{
		...
		normalMapShader.loadSkyColour(RED, GREEN, BLUE);
		...
		terrainShader.loadDensity(density);
